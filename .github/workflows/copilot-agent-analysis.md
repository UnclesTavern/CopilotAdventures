...
tools:
  repo-memory:
    ...
    file-glob:
      [
        "memory/copilot-agent-analysis/*.json",
        "memory/copilot-agent-analysis/*.jsonl",
        "memory/copilot-agent-analysis/*.csv",
        "memory/copilot-agent-analysis/*.md",
      ]
    max-file-size: 102400 # 100KB

timeout-minutes: 15

source: github/gh-aw/.github/workflows/copilot-agent-analysis.md@5551dc68ad4ffd1734611a2a43a576551999bf01
---
